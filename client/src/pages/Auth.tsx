  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to your AI tutor journey.",
      });
      setLocation("/");
    } catch (error: any) {
      toast({
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/10 via-background to-secondary/10 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Class 11 & 12 Learning Platform</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="register">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={registerData.selectedClass.toString()}
                    onValueChange={(value) =>
                      setRegisterData({ ...registerData, selectedClass: parseInt(value) })
                    }
                  >
